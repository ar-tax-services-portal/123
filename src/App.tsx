...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    console.log(`[DIAGNOSTIC] Router initialization: active page = "${currentPage}", isDemoRoute = ${isDemoRoute}, user = "${currentUser?.name || 'Guest'}"`);
  }, [currentPage, isDemoRoute, currentUser?.name]);
